...
#   사용법
#   1. 가상환경 세팅 : (ctrl + shift + p) /final-pjt/final-back/venv/Scripts/python(.exe) 선택
#   2. 현재 파일 실행 
#   3. /final-pjt/final-back/ 이동
#   4. $ python manage.py loaddata user_data.json
...
API_KEY = 'b5a31b7058b58621ae4f3f07483d0826'
...
save_dir = './final-pjt-back/user_data.json'
with open(save_dir, 'w', encoding="utf-8") as f:
    ...
    for i in range(N):
        ...
        file["fields"] = {
            ...
            'password': "pbkdf2_sha256$600000$0lwVah7Dh5MESfsHG8pAkP$Lt1C7tz5MgcMlzFN1lQVWt+ImEOSKs+tOogYVpKNgMQ=", # 입력해야할 비밀 번호 = ssafy1234
            'nickname': None,
            'is_active': True,
            'is_staff': False,
            'is_superuser': False
